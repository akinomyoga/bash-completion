...
## [2.14.0](https://github.com/akinomyoga/bash-completion/compare/v2.13.0...2.14.0) (2024-04-28)


### Features

* **_comp_backup_glob:** add `ucf` generated backup files ([351be1c](https://github.com/akinomyoga/bash-completion/commit/351be1c81ecd97135d3df64475a93d57526d5630))
* **_comp_backup_glob:** require dash in dpkg backup files ([59a57f9](https://github.com/akinomyoga/bash-completion/commit/59a57f9f8c6a47dc9d21c61d13ffb90a5f3b82f0))
* **_comp_compgen_{filedir,set}:** define exit status ([7920c9d](https://github.com/akinomyoga/bash-completion/commit/7920c9dbe46bd5ad0a92e78b744f00ffe8b14e76))
* **_comp_compgen_commands:** align return value with other compgens ([9d3362e](https://github.com/akinomyoga/bash-completion/commit/9d3362e4a092efaecda2fa2a5f01feca75e7b24e))
* **_comp_compgen_commands:** auto set `-o filenames` when appropriate ([4d4839e](https://github.com/akinomyoga/bash-completion/commit/4d4839e50210de4d3a8780caa4b9d8ab44b8f86d))
* **_comp_compgen_commands:** include dirs ([b9c7b5d](https://github.com/akinomyoga/bash-completion/commit/b9c7b5dc414c09d27a6b157d37bede70e662b91c))
* **_comp_compgen_known_hosts:** return 2 on usage error ([43bb8f0](https://github.com/akinomyoga/bash-completion/commit/43bb8f03798811d95a3068a8a53d2eac9ad877b5))
* **_comp_compgen:** support `-i cmd` and `-x cmd` ([39cc200](https://github.com/akinomyoga/bash-completion/commit/39cc200f9e6d9b03d1e76a924371f85304e786d5))
* **_comp_compgen:** support `-U var` to unlocal var ([b603535](https://github.com/akinomyoga/bash-completion/commit/b60353508eb470515f1063a1e1a75bdf1fda730f))
* **_comp_expand_glob:** fail when no paths are generated ([6b0a466](https://github.com/akinomyoga/bash-completion/commit/6b0a46644d587182c20f880755a821a7680753fe))
* **_comp_get_fist_arg:** support "-o GLOB" to skip optargs ([0f14cc0](https://github.com/akinomyoga/bash-completion/commit/0f14cc030ebdb54f3d120d8cadc08651dad00624))
* add `_comp_locate_first_arg` ([0384bd5](https://github.com/akinomyoga/bash-completion/commit/0384bd51df3f68a3e065aeead4e921462fff6655))
* **airflow:** add fallback 3rd party completion loader ([bf5550b](https://github.com/akinomyoga/bash-completion/commit/bf5550b5fc304ed956b6061221f173516408d82d))
* **ansible*:** add fallback 3rd party completion loader ([5f8384e](https://github.com/akinomyoga/bash-completion/commit/5f8384ef71acd1dc6e214177e5bbe3b0b83ee976))
* **b2sum:** new completion ([cd985df](https://github.com/akinomyoga/bash-completion/commit/cd985df6d8e613fd5421066248db1c50dc1686bd))
* **bash_completion:** add function _comp_compgen_ltrim_colon ([ce5889b](https://github.com/akinomyoga/bash-completion/commit/ce5889ba3b1364d9afe7096c6fa14d7c65d08cc6))
* **black,blackd:** add fallback 3rd party completion loader ([47a1f05](https://github.com/akinomyoga/bash-completion/commit/47a1f05e75399d25dcf0281ae6f8ba363a82e6bc))
* **carton:** support exec command completions ([0eb3a21](https://github.com/akinomyoga/bash-completion/commit/0eb3a21afdcd4c52966e0894f43f501dc3b727e3))
* **chezmoi:** add 3rd-party completion loader (cobra) ([31baa69](https://github.com/akinomyoga/bash-completion/commit/31baa69954351a2d30047f707692d361646aea53))
* **conda:** add 3rd-party completion loader (argcomplete) ([c0f5ba2](https://github.com/akinomyoga/bash-completion/commit/c0f5ba2e19abea70dcde4bf0aafe36de801b28c0))
* **crc:** add 3rd-party completion loader (cobra) ([f10866e](https://github.com/akinomyoga/bash-completion/commit/f10866e1aaf810ae5cb29ccd5c1e8ac722d0f2ae))
* **curl:** Complete protocols for --proto-default ([7051379](https://github.com/akinomyoga/bash-completion/commit/7051379e448147407c3fe43c89872dafb76ebb27))
* **cz:** add fallback 3rd party completion loader ([b7ba70e](https://github.com/akinomyoga/bash-completion/commit/b7ba70e52e1e0f287c29b5d7362439dccd132e8b))
* **dlv:** add 3rd party fallback completion loader ([eefe71d](https://github.com/akinomyoga/bash-completion/commit/eefe71d8681d0735abc541cd0b7d2c7f9c535212))
* **dot:** support filename extension .gv ([be0010e](https://github.com/akinomyoga/bash-completion/commit/be0010e8517de89bf06bda02bdccacc51968136e))
* **dprint:** add fallback 3rd party completion loader ([e201e0e](https://github.com/akinomyoga/bash-completion/commit/e201e0ee336e79c26bce2afc3f2b4f98d4fea12d))
* **env:** complete commands and variable assignments ([5c75fa3](https://github.com/akinomyoga/bash-completion/commit/5c75fa332b5f86863f14c2ef45cdc8732c9a2c35))
* **env:** treat `-*` as the command name after `-` and `--` ([0cd2883](https://github.com/akinomyoga/bash-completion/commit/0cd2883ca17e65a86fe81c650cea869f9fc70839))
* **env:** treat `-*` as the command name after assignments ([71b7fb2](https://github.com/akinomyoga/bash-completion/commit/71b7fb2bc6fd9eef901e959aaf089419cc6f74a4))
* **eog:** add missing extension .heif ([9e4a48f](https://github.com/akinomyoga/bash-completion/commit/9e4a48fdaa372a41e6ad5c7d021164394054aa97))
* **eog:** associate with `*.avif` and `*.webp` ([#1005](https://github.com/akinomyoga/bash-completion/issues/1005)) ([f1c04b8](https://github.com/akinomyoga/bash-completion/commit/f1c04b816e1612acdac62605528d32b5d896916f))
* **eog:** associate with `*.heic` and `*.jxl` ([20c9cea](https://github.com/akinomyoga/bash-completion/commit/20c9cea129e1f1e92045098ce7555a3f2add30e8))
* **eog:** associate with `*.pbm` ([#1006](https://github.com/akinomyoga/bash-completion/issues/1006)) ([5472cc1](https://github.com/akinomyoga/bash-completion/commit/5472cc1fef9c60abf240bd8f4acf38dbdaabf1a1))
* **feh:** associate with y4m and heic/heif/avif ([e252c73](https://github.com/akinomyoga/bash-completion/commit/e252c73ff2b92320dfabc9daf0d3f4ac15171e96))
* **feh:** deassociate with avci/avcs ([af46f34](https://github.com/akinomyoga/bash-completion/commit/af46f3411acfbd28624f57ff6a7511148d1857f9))
* **flask:** add fallback 3rd party completion loader ([3e0d00d](https://github.com/akinomyoga/bash-completion/commit/3e0d00d4ea55a200ea67196a6de841e8633fcad3))
* **gup:** add 3rd party fallback completion loader (&gt;= 0.25.0) ([1641f1a](https://github.com/akinomyoga/bash-completion/commit/1641f1a3043e3a378b4dd08a0f07240dd1d56548))
* **hash:** new completion ([#1013](https://github.com/akinomyoga/bash-completion/issues/1013)) ([4d0bffb](https://github.com/akinomyoga/bash-completion/commit/4d0bffb791c34c96114aeb2e4f6726b80aa8698e))
* **httpx:** add fallback 3rd party completion loader ([3f4861c](https://github.com/akinomyoga/bash-completion/commit/3f4861cc41ea05982b2c4a98cc1f56f21895419b))
* **incus:** add 3rd party fallback completion loader ([7108d9c](https://github.com/akinomyoga/bash-completion/commit/7108d9ca84a2617ae36e88181d39aeeabe3225dd))
* **ip:** Add completion for monitor subcommand ([fa696e6](https://github.com/akinomyoga/bash-completion/commit/fa696e60f3fe525a14bfbb409effb4e51b2e4450))
* **ip:** Add completion for netconf subcommand ([03a10ff](https://github.com/akinomyoga/bash-completion/commit/03a10ff63226782e61dae4407138c3240ff0c7c2))
* **ip:** Complete commands for netns exec ([1f03796](https://github.com/akinomyoga/bash-completion/commit/1f03796cd930ddad6207d46814da820674f16edc))
* **ip:** Complete help for unknown subcommands ([21f7e32](https://github.com/akinomyoga/bash-completion/commit/21f7e32f9009c2064d1659668425b6b6ccb537bd))
* **ip:** Complete ip link property ([efa663c](https://github.com/akinomyoga/bash-completion/commit/efa663cd0dd63d54fd2d2987ee66fb954ccf4a86))
* **ip:** Complete link types for address show ([ca5ea03](https://github.com/akinomyoga/bash-completion/commit/ca5ea037e2ec1b0b5ec4d31295df88125d51b43e))
* **ip:** Complete neigh show and flush ([c7c3c03](https://github.com/akinomyoga/bash-completion/commit/c7c3c039bf5a462ea577e8fcc92ebd94d6afad49))
* **ip:** Complete stats subcommand ([cd73e8c](https://github.com/akinomyoga/bash-completion/commit/cd73e8c1689e3e014c4a75d5101ee3d932013120))
* **ip:** Create function to get link types ([8e60245](https://github.com/akinomyoga/bash-completion/commit/8e60245c7531e1615dc96b032035bb4f59972f4a))
* **jungle:** add fallback 3rd-party completion loader ([c69845a](https://github.com/akinomyoga/bash-completion/commit/c69845abf7efe9c226cef46ebf8b9129058db43d))
* **keyring:** add fallback 3rd party completion loader ([8082602](https://github.com/akinomyoga/bash-completion/commit/80826028b7760409f20624a6fb4f4c5a4eaec8e3))
* **kontena:** add fallback 3rd-party completion loader ([5eef0ce](https://github.com/akinomyoga/bash-completion/commit/5eef0ce3e5bd29f32d5830abfaf60da1295c4562))
* **lefthook:** add fallback 3rd party completion loader ([dc9650e](https://github.com/akinomyoga/bash-completion/commit/dc9650e917d2018fa9eeb251e2c3db2b0f9d230a))
* no empty command completion if `no_empty_cmd_completion` is on ([faab292](https://github.com/akinomyoga/bash-completion/commit/faab29286074ec3c952dfe50f0cb22af65dadbeb))
* **npm:** add fallback 3rd-party completion loader ([f1c085c](https://github.com/akinomyoga/bash-completion/commit/f1c085cc56cf15d2bd0c97148535e36e81dfc5d4))
* **nvm:** add fallback 3rd-party completion loader ([dea7e1d](https://github.com/akinomyoga/bash-completion/commit/dea7e1d431f1700c2515ece47b07ba472e1f999c))
* **oc:** add 3rd-party completion loader (cobra) ([26b5f09](https://github.com/akinomyoga/bash-completion/commit/26b5f09490159fd8fc6b7c592cb70c40e8b214dc))
* **pip{,3}:** add fallback 3rd-party completion loader ([e3cbfba](https://github.com/akinomyoga/bash-completion/commit/e3cbfba64e6f52ee49c59052ef40eb4a11a48849))
* **pipenv:** add fallback 3rd party completion loader ([#1020](https://github.com/akinomyoga/bash-completion/issues/1020)) ([6ecf5bd](https://github.com/akinomyoga/bash-completion/commit/6ecf5bdb3c534db894da60e336f58235547de80d))
* **pytest:** complete new --import-mode value ([#1021](https://github.com/akinomyoga/bash-completion/issues/1021)) ([2d636a3](https://github.com/akinomyoga/bash-completion/commit/2d636a3cb4ee66b4bc3355fadff1a1e4246199d4))
* **rg:** add fallback 3rd party completion loader ([7e4cc2f](https://github.com/akinomyoga/bash-completion/commit/7e4cc2fb199f1c88bd9a358a157fe06327fc2b28))
* **rtx:** add fallback 3rd party completion loader ([0628e22](https://github.com/akinomyoga/bash-completion/commit/0628e223689b7bad0b9dc43e56d935a66b73b8a2))
* **ssh-add:** (non-)complete -H, -h, and -S arguments ([757045a](https://github.com/akinomyoga/bash-completion/commit/757045a5907080142896cad0cfe0351bc6f6aedb))
* **ssh-inscribe:** add fallback 3rd party completion loader ([7f2c197](https://github.com/akinomyoga/bash-completion/commit/7f2c197e4e59b313d0f47cde902f57145106660e))
* **ssh-keyscan:** complete -O argument ([39ea543](https://github.com/akinomyoga/bash-completion/commit/39ea5435abfc4b13445bb0eec086e246e3cadb38))
* **ssh:** complete RequiredRSASize ([#1064](https://github.com/akinomyoga/bash-completion/issues/1064)) ([de15205](https://github.com/akinomyoga/bash-completion/commit/de15205d6c7997e8596dce4f9d2a2bfc476be716))
* **tkn-pac:** add 3rd-party completion loader (cobra) ([d0f2604](https://github.com/akinomyoga/bash-completion/commit/d0f26045937276427ebb9844e84f40cff1b928f4))
* **tkn:** add 3rd-party completion loader (cobra) ([161fc5d](https://github.com/akinomyoga/bash-completion/commit/161fc5d42cd7dd814a9197f788045ca052062c22))
* **xmllint,xmlwf:** also suggest *.rss files ([a89cde2](https://github.com/akinomyoga/bash-completion/commit/a89cde2216b1634521b4a264b2dbc5cda7522061))
* **xrandr:** comma separated `--setmonitor` third argument ([8a76f3d](https://github.com/akinomyoga/bash-completion/commit/8a76f3d75db290302f94ea732e01a9afd25c2c24))
* **zarf:** add 3rd party fallback completion loader ([032f0f0](https://github.com/akinomyoga/bash-completion/commit/032f0f0f35b53856c3be642bb3101a4d01c81aee))


### Bug Fixes

* **__load_completion:** quoted compspec for variants ([#1008](https://github.com/akinomyoga/bash-completion/issues/1008)) ([0a2443e](https://github.com/akinomyoga/bash-completion/commit/0a2443e3eec8557273dd905df9a28dc177861023))
* **_cd_devices:** `/dev/cdc-*` CDC device false positives ([5250728](https://github.com/akinomyoga/bash-completion/commit/52507286a6ea8c576414d7cca0f6a2d30dd78c84))
* **_comp__init_set_up_service_completions:** work around failglob ([2529d40](https://github.com/akinomyoga/bash-completion/commit/2529d40f22039b344fd0bb5280a8469b8783f2a9))
* **_comp_{compgen,xfunc}:** use `declare -F --` for arbitrary funcs ([8998491](https://github.com/akinomyoga/bash-completion/commit/899849127707f6d616d5312c0efab0092b8caea8))
* **_comp_{first_arg,count_args}:** count - as argument ([e23a79e](https://github.com/akinomyoga/bash-completion/commit/e23a79e0fd715b0ae564082d9f1e4e7a907a195d))
* **_comp_{first_arg,count_args}:** count any arguments after -- ([9bfd760](https://github.com/akinomyoga/bash-completion/commit/9bfd760c1192da7b3d0d8f0f9c8bea8ed16f4e47))
* **_comp_{load,realcommand}:** handle option-like command name ([883946d](https://github.com/akinomyoga/bash-completion/commit/883946d84d13d7947eb0c21a536bd947b3dbc31a))
* **_comp_command_offset:** Support complete -C ([80450ca](https://github.com/akinomyoga/bash-completion/commit/80450ca06973535671dc76ffe5abd6e377418f76))
* **_comp_compgen_fstypes:** avoid unexpected expansions ([a856d81](https://github.com/akinomyoga/bash-completion/commit/a856d811b73500550d317eff5fec487e41581add))
* **_comp_compgen_help:** allow dots to connect names in longopt ([79dadfc](https://github.com/akinomyoga/bash-completion/commit/79dadfc7fa37be26c7b263b809687db0907ae71f))
* **_comp_compgen_known_hosts:** work around bash-4.2 nounset ([d2860cb](https://github.com/akinomyoga/bash-completion/commit/d2860cb481be8f3cf97172cb1bf063da8f238e53))
* **_comp_compgen_split:** work around nounset ([f488f96](https://github.com/akinomyoga/bash-completion/commit/f488f9615a58140dc610bf2d406f3fcf6b8d82da))
* **_comp_compgen_term:** replace completions by default ([d3696a3](https://github.com/akinomyoga/bash-completion/commit/d3696a3f793b2e0b9a0940287b3ab3dd23ef247d))
* **_comp_compgen_usergroup:** avoid directly overwriting COMPREPLY ([d380498](https://github.com/akinomyoga/bash-completion/commit/d3804982650ec4fc7fbb7f7cab5522709b43f52d))
* **_comp_compgen:** do not inherit -a for explicitly specified var ([3c20766](https://github.com/akinomyoga/bash-completion/commit/3c20766a6248aec000eb55731dd6b159ecf45dc2))
* **_comp_compgen:** explicitly exclude `cur` from the target variable ([5fe98f3](https://github.com/akinomyoga/bash-completion/commit/5fe98f3c30fa69d0921703c7c90522a28bb00737))
* **_comp_count_args:** check optarg correctly ([874c503](https://github.com/akinomyoga/bash-completion/commit/874c5031986e23a3ca7843d216d7dde94b0f1d4b))
* **_comp_count_args:** exclude &lt;&gt;& from wordbreaks as _comp_initialize ([521d2bb](https://github.com/akinomyoga/bash-completion/commit/521d2bb5330de4a721ae20d37d330190aa4beef0))
* **_comp_count_args:** ignore empty $3 ([76eea74](https://github.com/akinomyoga/bash-completion/commit/76eea74581d4f404e817f686ea86236c8c75a9fc))
* **_comp_count_args:** perform optarg check also on $3 ([21d3122](https://github.com/akinomyoga/bash-completion/commit/21d3122fa933169849e9743212248c80b7843abb))
* **_comp_count_args:** skip reassembling cword and words ([3127703](https://github.com/akinomyoga/bash-completion/commit/3127703f12f3e82ddf3f950a801ab430024aca22))
* **_comp_delimited:** treat delimiter as a fixed string ([571a0f7](https://github.com/akinomyoga/bash-completion/commit/571a0f70f39fed70b2db51e1624b2a0ee29f00c4))
* **_comp_deprecate_func:** argument order in usage error message ([597f62f](https://github.com/akinomyoga/bash-completion/commit/597f62fe38627452f5330d40bc9004f2b3d4dda5))
* **_comp_get_words:** empty prev if unavailable (localvar_inherit) ([d8b8eef](https://github.com/akinomyoga/bash-completion/commit/d8b8eef63602cb0e34837320938b0819363d7d87))
* **_comp_initialize:** fix completions of redirections without space ([da16bf6](https://github.com/akinomyoga/bash-completion/commit/da16bf61c2604ea4efa9b2d125aedd2dd4acd4e5))
* **_comp_initialize:** protect against "localvar_inherit" ([0cc8d83](https://github.com/akinomyoga/bash-completion/commit/0cc8d833011c0763eb00939ad9a94d525d87bcea))
* **_comp_split,_comp_compgen:** strip periods from error message ([b3b6a7c](https://github.com/akinomyoga/bash-completion/commit/b3b6a7cf2865b3591ab571dc2563d1980a822ac5))
* **_comp_split:** update error message for the correct options ([3c4a89c](https://github.com/akinomyoga/bash-completion/commit/3c4a89ce48ca29c0c6461d12519bbf78bcc1ca02))
* **_comp_sysvdirs:** work around nounset ([da26178](https://github.com/akinomyoga/bash-completion/commit/da26178b9c7eaf11711b451ae292a01bd423a80c))
* **_filedir_xspec:** clean up unused variable `tmp` ([67f1189](https://github.com/akinomyoga/bash-completion/commit/67f11892351b710b9b3609e138a0a2c9248c4422))
* **_get_cword_at_cursor,cvs:** quote array length ([201239c](https://github.com/akinomyoga/bash-completion/commit/201239cb597a3d7d0165a5e37a093f063fe700d1))
* **_get_first_arg:** remove invalid doccomment ([eb40f56](https://github.com/akinomyoga/bash-completion/commit/eb40f566cc9e3c5a845a12caf0f4344dab2a0b2c))
* **_known_hosts:** use array for `options` (work around SC2178,SC2179) ([743d0a9](https://github.com/akinomyoga/bash-completion/commit/743d0a9be714c516dce23415e3a5c5f81d5d7bea))
* **_mock,rpm:** avoid icase flag `s/reg/rep/i` of GNU sed ([33c18ce](https://github.com/akinomyoga/bash-completion/commit/33c18ce90df153dabb89813d472dacf5a6259b92))
* **_slackpkg:** do not scan after cword ([ecd1384](https://github.com/akinomyoga/bash-completion/commit/ecd13849f76966d9e15607bdd604972279bb9cd8))
* **ant:** work around custom IFS ([584e567](https://github.com/akinomyoga/bash-completion/commit/584e56748da32e8f17a713b14c23ea2b7c92a4dc))
* **apt-cache:** check all the words ([84cfeda](https://github.com/akinomyoga/bash-completion/commit/84cfedabe958ad6f7cfc52525d79e9b801de4233))
* **aptitude:** do not use non-POSIX BRE \w ([cd8c870](https://github.com/akinomyoga/bash-completion/commit/cd8c8701b60f17f9aecc27482f64f121821085ee))
* **aspell:** use `_comp_expand_glob` against unexpected splitting ([58d5176](https://github.com/akinomyoga/bash-completion/commit/58d5176cba8bb25fe5348aadef100c083afa992f))
* **available_interfaces:** fix regression of unwanted trailing colons ([c2f83e0](https://github.com/akinomyoga/bash-completion/commit/c2f83e0436208ef2bfa9c762bc28ff6374ba0c73))
* **bash_completion,conftest:** use `complete -p --` for arbitrary cmds ([dafd338](https://github.com/akinomyoga/bash-completion/commit/dafd3382e019cf90156cc6abc4266a82ab4ebe5f))
* **bash_completion:** remove some unnecessary `-a` to `_comp_compgen` ([636bb7c](https://github.com/akinomyoga/bash-completion/commit/636bb7c4062c3e410904769f1fde4f5b14a12afc))
* **bts:** update functions to generators and fix variable conflicts ([7d2867c](https://github.com/akinomyoga/bash-completion/commit/7d2867c01527c3037579fe24da62cccfdfd1883e))
* **carton:** remove a branch never happening ([cd063f9](https://github.com/akinomyoga/bash-completion/commit/cd063f9a40e4dc85e0a9de7ceeac019cdac57449))
* **chgrp:** fix typo `_comp_compgen{d  =&gt; _}filedir` ([#1063](https://github.com/akinomyoga/bash-completion/issues/1063)) ([4c98ce5](https://github.com/akinomyoga/bash-completion/commit/4c98ce58b7686b9f23f14bf05e809d9cd1a5669c))
* **compat:** find compat dir for prefix-install ([b6d06bc](https://github.com/akinomyoga/bash-completion/commit/b6d06bc47119fcfc47f10eed328ff54e95ddc14d))
* **completions/*:** quote array assignments properly ([848aa41](https://github.com/akinomyoga/bash-completion/commit/848aa413273516529ccc163966f138ad3a6c53a0))
* **completions/*:** scan until cword instead of ${#words[@]}-1 ([17e0cc3](https://github.com/akinomyoga/bash-completion/commit/17e0cc36fdb4c6543c7729419d6f736ee779db1f))
* **completions/*:** work around localvar_inherit ([e3a871d](https://github.com/akinomyoga/bash-completion/commit/e3a871d2517f688d7fe7132f33e96669a71b6aa1))
* **curl,qemu:** avoid using POSIX character classes for mawk ([d60c530](https://github.com/akinomyoga/bash-completion/commit/d60c5306f918b370c74f5ba6d3100720be139ad6))
* **cvs,mutt,pkg_delete:** quote prefix to remove for literal matching ([533903e](https://github.com/akinomyoga/bash-completion/commit/533903edd5d0752cb4b910c3bcc6d86a0e55d779))
* **cvs:** avoid variable conflicts ([0d145c9](https://github.com/akinomyoga/bash-completion/commit/0d145c9f2852955848ca1855d9fae216ebbd78c3))
* **dict:** nounset error when host/port not set ([57191e2](https://github.com/akinomyoga/bash-completion/commit/57191e2731eb307434c2f11813d7dea303458dce))
* **dict:** protect splitting from custom IFS ([b31fe1e](https://github.com/akinomyoga/bash-completion/commit/b31fe1e3e1b3480d9dc6a469cae4e83ed204b382))
* **dict:** work around bash-4.2 array nounset ([d76dd9e](https://github.com/akinomyoga/bash-completion/commit/d76dd9ea448b71e111763e8048df49dde797d85e))
* **dict:** work around bash-4.3 ${v+"$@"} with custom IFS ([cc21298](https://github.com/akinomyoga/bash-completion/commit/cc212983a2b2523e5b62e9735c6dff5f011bb80a))
* **dmypy:** protect against "localvar_inherit" ([768ce65](https://github.com/akinomyoga/bash-completion/commit/768ce656099879ba1b81de04b75db11679791c47))
* **dpkg-source:** filter completions by `cur` ([dbcef6e](https://github.com/akinomyoga/bash-completion/commit/dbcef6e37313b00f00ca65397be6a061b1af3bb8))
* **filedir:** work around bash-4.2 `compgen -f -- "''"` ([c8bb123](https://github.com/akinomyoga/bash-completion/commit/c8bb123abc0c148bfa078cf8bfe01bafc5cf50ff))
* **fio:** engines completion ([27a0ef8](https://github.com/akinomyoga/bash-completion/commit/27a0ef80a2dbd84d8a0d2f90945cc66577149726))
* fix problems with `set -o nounset` ([9c3e196](https://github.com/akinomyoga/bash-completion/commit/9c3e1961928248da8a6dd8e327c3860f71eb7dff))
* **gdb:** fix regression that fails to generate command names ([ca8e240](https://github.com/akinomyoga/bash-completion/commit/ca8e2405ae49c927f9c9d312aa0efdde3d231bf2))
* **gdb:** remove duplicate candidates ([532fc05](https://github.com/akinomyoga/bash-completion/commit/532fc05a73b415369ce1987463d82d791ee72dc0))
* **gdb:** use POSIX-compatible find expression ([73938cd](https://github.com/akinomyoga/bash-completion/commit/73938cd857c3a7fa884e24be7216d1c5b12d5a1c))
* **gdb:** work around bash 4.4 ${v+"$@"} ([41236da](https://github.com/akinomyoga/bash-completion/commit/41236da411794133d08792df28207e2a77271c57))
* **get_words:** work around bash-4.3 connected ${v+"$@"} ([81affbd](https://github.com/akinomyoga/bash-completion/commit/81affbd999a24f796f79fb5c1eec80e88b3a98d8))
* **getent:** check noargopts ([6143f25](https://github.com/akinomyoga/bash-completion/commit/6143f257f1593c319504c2627fe01b4c94e90a48))
* **getent:** work around localvar_inherit ([a12f438](https://github.com/akinomyoga/bash-completion/commit/a12f438ebf93d7427d1b5df7056ace8ec67e890c))
* **gzip,isort:** fix typo `_comp_com{gp =&gt; pg}en` ([462feb3](https://github.com/akinomyoga/bash-completion/commit/462feb34d3b49f70a2451cbf724d14e59bfd8e0a))
* **ip:** Complete addrlabel add/del properties ([ea07616](https://github.com/akinomyoga/bash-completion/commit/ea076166e9a5cce9d22a27e63f95bbf00be9b894))
* **ip:** Complete ip delete with type correctly ([f3a9be3](https://github.com/akinomyoga/bash-completion/commit/f3a9be3e2f6eaf0d94bb66220fd02cf0e3c76481))
* **ip:** Complete more variations of subcommands ([c8920c5](https://github.com/akinomyoga/bash-completion/commit/c8920c57f83199a14230485cc44b426f028acafb))
* **ip:** Complete netns attach subcommand ([bfb1de6](https://github.com/akinomyoga/bash-completion/commit/bfb1de64a53d1eba749c9921cea3809460cd2319))
* **ip:** Complete only relevant addrlabel subcmds ([05147f1](https://github.com/akinomyoga/bash-completion/commit/05147f19d3d04040fa8dacbd9e1705bfc1432073))
* **iperf,puppet:** use \{m,n\} instead of \? and \+ for POSIX sed ([3f0322b](https://github.com/akinomyoga/bash-completion/commit/3f0322b73d98c177ede1973ad1b84e66ee593ca9))
* **iperf:** work around failglob with backslash in bash-5.0 ([979f04f](https://github.com/akinomyoga/bash-completion/commit/979f04f67c76395e21f77b7945639f2eeaa3b37f))
* **ip:** Keep completing after -netns name ([1a5df4f](https://github.com/akinomyoga/bash-completion/commit/1a5df4fe22eb374424b18e7db27b8446e919f4b2))
* **ip:** Quote all instantiation of ip as "$1" ([ef25163](https://github.com/akinomyoga/bash-completion/commit/ef25163e6bd9095e528b57d44cb31d32f0321bb9))
* **ip:** Quote network namespace names ([216734b](https://github.com/akinomyoga/bash-completion/commit/216734bed7ba02655128bf1dbc2f184420ad69ef))
* **ip:** Remove non-existent route completion ([3b9ce4d](https://github.com/akinomyoga/bash-completion/commit/3b9ce4dc0ba0a14d1d390f0e83c7b7b53a26b5a5))
* **isql:** work around nounset ([cb7007a](https://github.com/akinomyoga/bash-completion/commit/cb7007af225369e5872280411bb6871b55f274a5))
* **java,kldload:** use `_comp_compgen` for filename-based mod names ([81adc6c](https://github.com/akinomyoga/bash-completion/commit/81adc6ce741f69e936dfb0e1e891c372341814f2))
* **java:** localize `cur` ([ec0068d](https://github.com/akinomyoga/bash-completion/commit/ec0068d13f3c98551771e4ada4335f131c2f0cb4))
* **kcov,povray:** quote array expansions to avoid extra processing ([215edab](https://github.com/akinomyoga/bash-completion/commit/215edabcceece2b53becc78cf88a24fb120db299))
* **kldload,mplayer,mutt:** work around nounset ([5330fbe](https://github.com/akinomyoga/bash-completion/commit/5330fbeecdd490aa79f1cf7ce320e1b27a776d69))
* **known_hosts_real:** match `*.pub` instead of `*pub` ([470a644](https://github.com/akinomyoga/bash-completion/commit/470a644be3144d9fbd7d58d99d1c3fd73c773b9f))
* **known_hosts_real:** use `_comp_expand_glob` to avoid failglob ([672215e](https://github.com/akinomyoga/bash-completion/commit/672215e010d5f78085caf61cecda620b4c67f4ae))
* **known_hosts_real:** work around nounset ([07c619a](https://github.com/akinomyoga/bash-completion/commit/07c619a56950de1960312ae24411c27688e5aa1a))
* **lilo,rpcdebug,slapt-{get,src}:** work around nounset ([cfc3eda](https://github.com/akinomyoga/bash-completion/commit/cfc3eda9575a8b0b48a531652875206db36957d5))
* **lvm:** replace array slices with existing utility ([ea49840](https://github.com/akinomyoga/bash-completion/commit/ea498402ccf07eb1e4acef0ad40a7c188e567145))
* **lvm:** update call to sub-command ([30494f7](https://github.com/akinomyoga/bash-completion/commit/30494f7b426c73b1a6a616f63d3510027c6fb02e))
* **Makefile:** include api-and-naming.md in dist ([fdd8048](https://github.com/akinomyoga/bash-completion/commit/fdd80487ba6944e639baf32ba991f8665840728d))
* **make:** handle multiple short options in skipping arguments ([24c80c9](https://github.com/akinomyoga/bash-completion/commit/24c80c91b7183ea5fcc9f2e7bc7ded303ea57d0a))
* **make:** typo fix in a code comment ([e72cc82](https://github.com/akinomyoga/bash-completion/commit/e72cc826534a0ea9dc840546134c19962697c3a0))
* **mdadm,update-alternatives:** fix leak variable ([14cd53b](https://github.com/akinomyoga/bash-completion/commit/14cd53bb38d0d0ef91bf82731e8946551f15023a))
* **mr:** avoid ${var/pat/$'...'} for compat42 in bash &gt;= 4.3 ([b5ae5fa](https://github.com/akinomyoga/bash-completion/commit/b5ae5fada8b788885b0fd65cca34b85672f08189))
* **mr:** exactly match command names ([800b103](https://github.com/akinomyoga/bash-completion/commit/800b10372e383124856c37b505d5dc9232eb1e45))
* **mutt:** avoid unexpected word splitting ([3183e67](https://github.com/akinomyoga/bash-completion/commit/3183e67c72fcf5ba3d713de59a5d6898a9a64952))
* **mutt:** fix use of regex in the glob context ([63924e6](https://github.com/akinomyoga/bash-completion/commit/63924e67527e5fa7698ac0610c7fd90c7ba36ecf))
* **mutt:** rewrite ${cur/#!/X} to X${cur:1} against patsub_replacement ([6b8f82b](https://github.com/akinomyoga/bash-completion/commit/6b8f82b44e2308db66bc10e4f3529fe0ca5137e5))
* **mutt:** use _comp_dequote for safe eval ([f98379d](https://github.com/akinomyoga/bash-completion/commit/f98379d33ee376df7a7f7de6fb85af8fffb469ee))
* **openssl:** avoid variable conflicts ([a31906c](https://github.com/akinomyoga/bash-completion/commit/a31906cd2886b51e74d5d1bcbae3528a0f9f135b))
* **openssl:** fix variable `i` leak ([83844b7](https://github.com/akinomyoga/bash-completion/commit/83844b7df11ad4ca02bb5da473fa4c5e8e3df80d))
* **perl:** fix ineffective condition in an awk script ([302dc52](https://github.com/akinomyoga/bash-completion/commit/302dc52b9b02dc9a8fa9b1833012b3c4f96b6d7b))
* **portinstall:** use awk and _comp_compgen to filter completions ([791f56c](https://github.com/akinomyoga/bash-completion/commit/791f56c62656ba19c4db804b7ccf8c2e8ba1d55a))
* **povray,sbopkg:** check filetype ([434eb08](https://github.com/akinomyoga/bash-completion/commit/434eb0853ed25c8730a38d5c3afbac170b397153))
* **povray:** process each element against patsub_replacement ([0afc2e4](https://github.com/akinomyoga/bash-completion/commit/0afc2e4a5db45b569827ca3bbef90f70bc7e74f5))
* **povray:** quote an argument properly ([0a240bd](https://github.com/akinomyoga/bash-completion/commit/0a240bd958a8aed9ef4251d0b223c42c60a77125))
* **python:** avoid variable conflicts ([bef94c3](https://github.com/akinomyoga/bash-completion/commit/bef94c39b9fac23655c8b50181d7834869d72702))
* **python:** complete filenames for script arguments ([#1018](https://github.com/akinomyoga/bash-completion/issues/1018)) ([397a49d](https://github.com/akinomyoga/bash-completion/commit/397a49d1c3a4faa5e15639d2852828f99b659bcc))
* **qdbus:** remove cur and all the rest arguments ([531b751](https://github.com/akinomyoga/bash-completion/commit/531b75142dc812a37b638de5c272c2356506fcc2))
* replace \s with [[:space:]] for POSIX sed/awk ([1989ba9](https://github.com/akinomyoga/bash-completion/commit/1989ba9ad3de5cf33da3c9623fa87be5194fac08))
* **ri:** avoid interference on existing COMPREPLY ([0a9d931](https://github.com/akinomyoga/bash-completion/commit/0a9d9319d50db21e0ca0051c19b9b3375790d353))
* **ri:** fix wrongly quoted options to compgen ([5248bbf](https://github.com/akinomyoga/bash-completion/commit/5248bbf475d275bd6fc743d62f6f7f3ab0c30a39))
* **ri:** properly split methods ([910a5a0](https://github.com/akinomyoga/bash-completion/commit/910a5a07c0f43095134c97c6b10db9d05505c3ef))
* **ri:** split classes using `_comp_split` ([c95baa1](https://github.com/akinomyoga/bash-completion/commit/c95baa12d7879c81967b6dc9df896255d3253781))
* **ri:** work around localvar_inherit ([9d6ff68](https://github.com/akinomyoga/bash-completion/commit/9d6ff689f44a2e560cbb643607f87551e7a88190))
* **sbopkg:** add `;` mandatory before `}` in POSIX sed ([b286d53](https://github.com/akinomyoga/bash-completion/commit/b286d53dec9e7fb5edb513afa8bd60f8c0e9b68c))
* **sbopkg:** work around nounset ([9709bdf](https://github.com/akinomyoga/bash-completion/commit/9709bdf226996878760ad87759f0011ff8587a3b))
* **ssh-add:** option parsing with recent versions ([2beb012](https://github.com/akinomyoga/bash-completion/commit/2beb012bf6a4f0dab1a9fa2612619c729b667e81))
* **ssh:** avoid variable conflicts ([f2df91d](https://github.com/akinomyoga/bash-completion/commit/f2df91d378004780d5237ab89faea2d6789169c0))
* **ssh:** fix wrong quoting inside compgen -W ([febb3b3](https://github.com/akinomyoga/bash-completion/commit/febb3b3257fca6402fc4c33c4de293bbf962580c))
* **ssh:** remove -a of generators ([55c5c45](https://github.com/akinomyoga/bash-completion/commit/55c5c459387e54ecdc869121fa97242e92ab87a8))
* **ssh:** remove unnecessary -a to _comp_compgen ([992f28e](https://github.com/akinomyoga/bash-completion/commit/992f28e73c82f3157e346845ba9e440b7f3d8f22))
* **ssh:** use `_comp_compgen` for `_comp_xfunc_ssh_identityfile` ([05e70ed](https://github.com/akinomyoga/bash-completion/commit/05e70ede40dc4b50cdeb67bfa8484af53d24f995))
* **ssh:** work around bash-4.2 nounset ([4447f83](https://github.com/akinomyoga/bash-completion/commit/4447f83c5d72823f336e3eefab2e8e10e080711b))
* **ssh:** work around bash-4.2 nounset ([d0695d0](https://github.com/akinomyoga/bash-completion/commit/d0695d0bc9d44d851d41b5c7e123ab6b95f29e81))
* **sudo:** use $1 (sudo) as $root_command ([329ca0e](https://github.com/akinomyoga/bash-completion/commit/329ca0eefd540b78e5fc287c2a4a2e2afdbfb45d))
* **svcadm:** fix ineffective IFS for splitting ([1fd456e](https://github.com/akinomyoga/bash-completion/commit/1fd456e7435b88811b82809dc5845ee53ff7aafb))
* **svcadm:** use the first matching name as command ([1870d5e](https://github.com/akinomyoga/bash-completion/commit/1870d5e0a67650a67c19895aefaae79eb2d6d76e))
* **sysbench:** fix extraction of test-name option ([cc246a1](https://github.com/akinomyoga/bash-completion/commit/cc246a1b7d0433996c99534f64e0363170ac00cd))
* **timeout:** always treat word after duration as command ([0d0531b](https://github.com/akinomyoga/bash-completion/commit/0d0531b254b03510f5dfa422a4198c33b5becd54))
* **tipc:** remove filtered-out elements ([75b36b2](https://github.com/akinomyoga/bash-completion/commit/75b36b20b57e67a253d0c2622e88ba84ccc3bc25))
* **update-alternatives:** suppress error for non-existent directory ([adbdab8](https://github.com/akinomyoga/bash-completion/commit/adbdab8fb5620e208826256e66851a1343f09e75))
* **update-alternatives:** work around localvar_inherit ([1d9e19c](https://github.com/akinomyoga/bash-completion/commit/1d9e19cd2ae3650aa81512dc2ab811a80c16ca33))
* **upgradepkg:** use `_comp_compgen` for `_comp_cmd_upgradepkg` ([a0973d7](https://github.com/akinomyoga/bash-completion/commit/a0973d77e8a3706490e33ba0f807727250b95c0e))
* use -- to pass arbitrary cmdnames to `_comp_load` ([3c1d9bc](https://github.com/akinomyoga/bash-completion/commit/3c1d9bc3f5432dee7de0935e8a4b6bf66c2fad77))
* use `_comp_compgen_split` to split and filter words ([158b8ba](https://github.com/akinomyoga/bash-completion/commit/158b8ba1de91913108507ae163611a44ae4871b0))
* use `_comp_compgen_split` while keeping filtering by $cur ([a00ee19](https://github.com/akinomyoga/bash-completion/commit/a00ee19962e78f51a12b83bb1b11b89dc7512b22))
* use `_comp_compgen` for word list ([83f033f](https://github.com/akinomyoga/bash-completion/commit/83f033f798c0fefbc9f37149d3bd40b0f238eabc))
* use `_comp_split` while keeping filtering by $cur ([509e642](https://github.com/akinomyoga/bash-completion/commit/509e642d42a696a5737c94dc296c69ed60a4dd3b))
* use `pathcmd=$(type -P -- "$1")` for arbitrary cmds ([8795ca9](https://github.com/akinomyoga/bash-completion/commit/8795ca99f3eb147e26d49f06e535f0ce64b4d162))
* use compgen -P prefix -W '"${arr[@]}"' against patsub_replacement ([45d036a](https://github.com/akinomyoga/bash-completion/commit/45d036ad804973a4b1916e818a73421435db444d))
* use XPG4 awk in Solaris ([cdd6da9](https://github.com/akinomyoga/bash-completion/commit/cdd6da9c77c7c99cab0aed7b9d7a5e4c0c5e0c78))
* **wol:** filter IP addresses by `cur` ([c3505c5](https://github.com/akinomyoga/bash-completion/commit/c3505c518f9d2695f678d82a1efcf35118af08ec))
* **wtf:** quote array assignment ([44c1d12](https://github.com/akinomyoga/bash-completion/commit/44c1d1292fdb840640a848aab6b2827002477ee9))
* **xfreerdp:** support the new form of the option /list:kbd ([d8cadfe](https://github.com/akinomyoga/bash-completion/commit/d8cadfea1036cb558f5c6f663843a19eaa3b5025))
* **xfunc ssh identityfile:** localize change to cur ([76b5726](https://github.com/akinomyoga/bash-completion/commit/76b572650f224e2e3b85918944af0bc8dfb49952))


### Performance Improvements

* **_comp_count_args:** skip reinitializing cword and words ([29398ef](https://github.com/akinomyoga/bash-completion/commit/29398efab4dd06fceb7c94c5329c5002b14cb8b4))
* **mutt:** return earlier on empty `cur` ([a244587](https://github.com/akinomyoga/bash-completion/commit/a244587e3c2d83bbef090438b329478da1896a4c))
* **portinstall:** return earlier for -lLo and non-existent file ([395e463](https://github.com/akinomyoga/bash-completion/commit/395e463d7e22bfb8b8b9f8ce4884ff7a979b2e35))
* **vncviewer:** set nocasematch inside subshell ([5ed0020](https://github.com/akinomyoga/bash-completion/commit/5ed0020f4ec39c5ff9994882cae9f04eb45e4ed7))
