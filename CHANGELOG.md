...
## [2.13.0](https://github.com/akinomyoga/bash-completion/compare/v2.12.0...2.13.0) (2024-02-21)
...
* **_comp_compgen:** support option -C ([6b3dfa5](https://github.com/akinomyoga/bash-completion/commit/6b3dfa529950f3bc51b8ead9323a82f65c5cfeb9))
...
* **_ip_addresses:** auto ltrim colon completions when appropriate ([ccdf953](https://github.com/akinomyoga/bash-completion/commit/ccdf953b7956d6fc65334e9049e157a3480a5cfa))
* add _comp_compgen_split ([542bf73](https://github.com/akinomyoga/bash-completion/commit/542bf73f571312659293dac664bf257ef66fbfef))
...
* **apt-get:** prefer `apt-cache` in same dir as command ([a731bfd](https://github.com/akinomyoga/bash-completion/commit/a731bfd0acf77c7e5ec52315e3b470cffa177b4a))
...
* **mailman:** prefer `list_lists` in same dir as command ([a46ccf1](https://github.com/akinomyoga/bash-completion/commit/a46ccf132d53f4f5adf5ad3b0e51ec1dde931298))
* **mysql:** prefer `mysqlshow` from same dir ([643886c](https://github.com/akinomyoga/bash-completion/commit/643886cf3c34eef47a86fbc6c2a64712c455dad3))
...
* **scp,sftp:** prefer `ssh` from same dir to resolve options etc ([d55f5e6](https://github.com/akinomyoga/bash-completion/commit/d55f5e6a9e9fb53b02bb86a8fc6278e671099bb0))
* **ssh-copy-id,ssh-keygen:** prefer `ssh` from same dir ([5c1d270](https://github.com/akinomyoga/bash-completion/commit/5c1d2701456e14fbe946ef7ccfecc7e10829b806))
...
* **_service:** quote word ([c2d7fb7](https://github.com/akinomyoga/bash-completion/commit/c2d7fb73844531ccb10576ddd905fb058e00c88e))
...
* **7z:** remove redundant `printf '%s\n' "..."` ([20c2e32](https://github.com/akinomyoga/bash-completion/commit/20c2e322f8eb93240de73b62647e7ca2f7b8fa4f))
...
* **curl,koji:** use _comp_compgen_help ([f37f221](https://github.com/akinomyoga/bash-completion/commit/f37f221f3f191fec0d301815d276d830f6119186))
...
* **curl:** colon handling for IPv6 address completions ([8508d1d](https://github.com/akinomyoga/bash-completion/commit/8508d1d8f6f3d50ac6fb45ec2eb0f05dcef8d817))
...
* **kldunload:** remove unused -X option ([35017d2](https://github.com/akinomyoga/bash-completion/commit/35017d25acee6830d4c30485a1b2cba2f12e00ed))
...
* **medusa:** filter completions by the current word `cur` ([f3ae706](https://github.com/akinomyoga/bash-completion/commit/f3ae706e114c4924416c50cca90473e6ce98ae20))
...
* **perl:** helper call regression from 01611dd3d ([b85263a](https://github.com/akinomyoga/bash-completion/commit/b85263a6de7f8e60f09489caac3f9a0d613e804f))
* **pgrep:** do not rely on uncontrolled IFS ([99e38b2](https://github.com/akinomyoga/bash-completion/commit/99e38b27424a53f901ec274269f5646bb4b02850))
...
* **ps,ss:** avoid extra expansions by -W "$(...)" in _comp_delimited ([cb347cb](https://github.com/akinomyoga/bash-completion/commit/cb347cb208c5708e30aa3d847849aa6ce71ba814))
* **pydoc:** specify -a to _comp_compgen_filedir ([34a91e9](https://github.com/akinomyoga/bash-completion/commit/34a91e9425992262913cbacf36706618a6f99bd4))
* **pytest:** do not filter underscores from parsed option arg choices ([ea13241](https://github.com/akinomyoga/bash-completion/commit/ea13241b2aaa9361ba6d701aaadd8f4ce39dc28a))
...
* **python:** complete micropython and pyston script args consistently ([5b60ccc](https://github.com/akinomyoga/bash-completion/commit/5b60ccc1ee573637263bdaac070065af1406de4d))
...
* **scp:** `nounset` mode error on unknown suboption, bash 4.2 ([82ca8d9](https://github.com/akinomyoga/bash-completion/commit/82ca8d924c4514f6570861d97b1ed953cbf9fe11))
* **ssh-copy-id:** call ssh, not -copy-id for suboption completion check ([473278f](https://github.com/akinomyoga/bash-completion/commit/473278faed2f6d7d894dc674e71d1cef41022b6c))
* **ssh-keygen:** call ssh, not -keygen to resolve supported protocols ([d569ea2](https://github.com/akinomyoga/bash-completion/commit/d569ea26389824b73732157947193efaea5f4ba8))
* **ssh-keygen:** first arg to ssh query for protocol versions ([8a0a71e](https://github.com/akinomyoga/bash-completion/commit/8a0a71e449b5458f89fbc55b0ab7d6f6bf6656e9))
...
* **ssh:** resolve relative ssh_config Include correctly ([4ac86e8](https://github.com/akinomyoga/bash-completion/commit/4ac86e84e55e793ba468c8cb6111510c9831377b))
...
* **update-alternatives:** quote dirname ([1205ed1](https://github.com/akinomyoga/bash-completion/commit/1205ed1958fa914faa8ccec778079e3f0ea2945b))
...
* use _comp_compgen_split to avoid extra expansions by -W "$(...)" ([49997d0](https://github.com/akinomyoga/bash-completion/commit/49997d0b2ff4fbbea37558570632e096d777ee54))
